...
interface CardModoLentoMensagensProps {
    settings: SlowModeSettings;
    onSettingsChange: (newSettings: Partial<SlowModeSettings>) => void;
}
...
const CardModoLentoMensagens: React.FC<CardModoLentoMensagensProps> = ({ settings, onSettingsChange }) => {
    const timePresets = [
        { label: '5s', value: 5 },
        { label: '10s', value: 10 },
        { label: '30s', value: 30 },
        ...
        <div className="bg-black/20 border border-white/10 rounded-2xl overflow-hidden">
            <div className="p-4">
                <div className="flex items-center justify-between">
                    <div>
                        <h3 className="font-semibold text-white text-base">Modo Lento</h3>
                        <p className="text-sm text-gray-400/80 mt-1">
                            Defina um intervalo entre as mensagens dos membros.
                        </p>
                    </div>
...
export default CardModoLentoMensagens;
