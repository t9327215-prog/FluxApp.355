...
interface GraficoLinhaReceitaProps {
    data?: LineChartData[];
    loading: boolean;
    title: string;
}
...
export const GraficoLinhaReceita: React.FC<GraficoLinhaReceitaProps> = ({ data, loading, title }) => {
        ...
        return (
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 col-span-1 md:col-span-3">
                ...
                <div className="text-center py-16">
                    <i className="fa-solid fa-chart-line text-4xl text-white/20 mb-3"></i>
            ...
            <div style={{ width: '100%', height: 300 }}>
                <ResponsiveContainer>
                    ...
                    >
                        ...
                        />
                        <Line type="monotone" dataKey="value" stroke="#00c2ff" strokeWidth={2} dot={{ r: 4 }} activeDot={{ r: 8 }} />
                    </LineChart>
                </ResponsiveContainer>
            </div>
        </div>
