...
interface FormularioStripeUpiProps {
    onBack: () => void;
}

/**
 * Componente visual que renderiza as instruções de pagamento para UPI.
 * Utiliza o PaymentElement da Stripe para exibir o QR Code e as instruções
 * necessárias para pagamentos com UPI.
 */
export const FormularioStripeUpi: React.FC<FormularioStripeUpiProps> = ({ onBack }) => {
    ...
    return (
        <div className="w-full max-w-md mx-auto bg-[#0f1b2a] p-8 rounded-lg shadow-lg">
            <div className="text-center mb-6">
                ...
                <p className="text-gray-400 mt-2">Scan the QR code with your UPI app to complete the payment.</p>
            </div>
            ...
            {stripe && elements ? (
                ...
                <div className="py-10 text-center animate-pulse">
                    ...
                    <p className="text-xs font-black text-gray-500 uppercase tracking-widest mt-3">Loading UPI information...</p>
                </div>
            )}
