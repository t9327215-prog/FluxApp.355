...
interface CardNotificacaoCurtidasProps {
...
export const CardNotificacaoCurtidas: React.FC<CardNotificacaoCurtidasProps> = ({ notif }) => {
    ...
    return (
        <div
            className="notification-item like-notification"
        ...
        >
            ...
            <div className="notification-content">
                <p className="notification-text">
                    <b className="font-bold">{notif.displayName}</b> curtiu sua publicação.
                </p>
