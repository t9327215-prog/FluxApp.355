const METRICS_ENDPOINT = '/api/metrics/reels';
 ...
 * @param {object} commentData - Dados do comentário (ex: { id, text, authorId, reelId }).
 */
export const trackReelsComment = async (commentData) => {
  console.log('Enviando evento de novo comentário no Reels:', commentData);
  try {
    ...
    if (!response.ok) {
      throw new Error('Falha ao rastrear o comentário do Reels');
    }
    return await response.json();
  } catch (error) {
    console.error('Erro ao rastrear o comentário do Reels:', error);
    throw error;
  }
};
 ...
 */
export const trackReelsCommentLike = async (commentId) => {
  console.log(`Enviando evento de like no comentário do Reels: ${commentId}`);
  try {
    ...
    if (!response.ok) {
      throw new Error('Falha ao rastrear o like no comentário do Reels');
    }
    return await response.json();
  } catch (error) {
    console.error('Erro ao rastrear o like no comentário do Reels:', error);
    throw error;
  }
};
 ...
 */
export const trackReelsCommentReply = async (commentId, replyData) => {
  console.log(`Enviando evento de resposta no comentário do Reels: ${commentId}`, replyData);
  try {
    ...
    if (!response.ok) {
      throw new Error('Falha ao rastrear a resposta ao comentário do Reels');
    }
    return await response.json();
  } catch (error) {
    console.error('Erro ao rastrear a resposta ao comentário do Reels:', error);
    throw error;
  }
};
